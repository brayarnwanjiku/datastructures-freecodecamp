...
def linear_locate_card(cards, query): 
    ...
    while position < len(cards):# This will eliminate instances where the list of cards is empty    
...
"""In the next solution we need to consider the complexity of the algorithm (Minimize the number of cards overturned)
